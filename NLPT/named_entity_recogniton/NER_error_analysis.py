from NLPT.named_entity_recogniton.util import encode_panx_dataset, tag_text
...
encode_panx_dataset(panx_ch['de'], tokenizer)

text = 'Jeff Dean ist ein Informatiker bei Google in Kalofornien'
print(tag_text(text, tokenizer, model, idx2tags))